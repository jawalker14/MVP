  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'InvoiceKasi',
        short_name: 'IK',
        description: 'Professional invoicing for every South African hustle',
        theme_color: '#e8b931',
      ...
      workbox: {
        ...
        // Offline fallback for navigation (not API or uploads)
        ...
        runtimeCaching: [
          ...
          // API requests — NetworkOnly (always real-time data)
          {
